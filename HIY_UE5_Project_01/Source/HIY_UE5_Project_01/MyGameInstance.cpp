...
void UMyGameInstance::Init()
{
	...
	uiParams.Name = TEXT("UIManager");
	_uiManager = GetWorld()->SpawnActor<AMyUIManager>(FVector::ZeroVector, FRotator::ZeroRotator, uiParams);

}

FMyStatData* UMyGameInstance::GetStatDataByLevel(int32 level)
{
